        ...
        <div class="pt-5">
            <div class="mb-6 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div class="panel h-full sm:col-span-2 lg:col-span-1">
                        ...
                        <div class="dropdown">
                            <client-only>
                                <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'" offsetDistance="0" class="align-middle">
                                    <button type="button">
                                        <svg
                                            class="hover:!text-primary dark:text-white/70 h-5 w-5 text-black/70"
                                            viewBox="0 0 24 24"
                                            fill="none"
                    ...
                    <div class="grid gap-8 overflow-hidden text-sm font-bold text-[#515365] sm:grid-cols-2">
                        <div>
                            <div>
                            ...
                            <client-only>
                                <apexchart height="58" :options="totalVisit" :series="totalVisitSeries" class="overflow-hidden">
                                    <!-- loader -->
                                    <div class="dark:bg-opacity-[0.08] grid min-h-[58px] place-content-center bg-white-light/30 dark:bg-dark">
                                        <span
                ...
                <div class="panel h-full">
                    ...
                    <div class="my-10 text-3xl font-bold text-[#e95f2b]">
                        ...
                        <svg class="inline h-5 w-5 text-success" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                opacity="0.5"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="dark:bg-dark-light/10 h-5 w-full overflow-hidden rounded-full bg-dark-light p-1 shadow-3xl dark:shadow-none">
                            <div
                                class="ltr:before:right-0.5 rtl:before:left-0.5 relative h-full w-full rounded-full bg-gradient-to-r from-[#4361ee] to-[#805dca] before:absolute before:inset-y-0 before:m-auto before:h-2 before:w-2 before:rounded-full before:bg-white"
                                style="width: 65%"
                            ></div>
                        </div>
                ...
                <div
                    class="panel before:bg-[#1937cc] grid h-full grid-cols-1 content-between overflow-hidden before:absolute before:-right-44 before:bottom-0 before:top-0 before:m-auto before:h-96 before:w-96 before:rounded-full"
                ...
                >
                    ...
                    <div class="z-10 flex items-center justify-between">
                        <div class="flex items-center justify-between">
                            <a
                                href="javascript:;"
                                class="hover:bg-[#1937cc] place-content-center rounded p-1 text-white-light shadow-[0_0_2px_0_#bfc9d4] ltr:mr-2 rtl:ml-2"
                            >
                                <svg
                                    class="h-5 w-5"
                                    viewBox="0 0 24 24"
                            ...
                            <a href="javascript:;" class="hover:bg-[#1937cc] grid place-content-center rounded p-1 text-white-light shadow-[0_0_2px_0_#bfc9d4]">
                        ...
                        <a href="javascript:;" class="hover:bg-[#4361ee] z-10 rounded p-1 text-white-light shadow-[0_0_2px_0_#bfc9d4]"> Upgrade </a>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 grid gap-6 lg:grid-cols-3">
                <div class="panel h-full p-0 lg:col-span-2">
                    <div class="dark:border-[#1b2e4b] mb-5 flex items-start justify-between border-b border-[#e0e6ed] p-5 dark:text-white-light">
                    ...
                    <div class="overflow-hidden">
                        <client-only>
                            <apexchart height="360" :options="uniqueVisitor" :series="uniqueVisitorSeries">
                                <!-- loader -->
                                <div class="dark:bg-opacity-[0.08] grid min-h-[360px] place-content-center bg-white-light/30 dark:bg-dark">
                                    <span
                                        class="inline-flex h-5 w-5 animate-spin rounded-full border-2 border-black !border-l-transparent dark:border-white"
                                    ></span>
                                </div>
                ...
                <div class="panel h-full">
                    <div class="dark:border-[#1b2e4b] -mx-5 mb-5 flex items-start justify-between border-b border-[#e0e6ed] p-5 pt-0 dark:text-white-light">
                    ...
                    <client-only>
                        <perfect-scrollbar
                            ...
                            class="relative h-[360px] ltr:-mr-3 ltr:pr-3 rtl:-ml-3 rtl:pl-3"
                        >
                            <div class="space-y-7">
                                <div class="flex">
                                    <div
                                        class="before:h-[calc(100%-24px)] before:w-[2px] before:bg-white-dark/30 relative z-10 shrink-0 before:absolute before:left-4 before:top-10 ltr:mr-2 rtl:ml-2"
                                    >
            ...
            <div class="mb-6 grid gap-6 sm:grid-cols-3 xl:grid-cols-5">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="w-full flex-initial px-3">
                                ...
                                <div>
                                    <div class="dark:bg-dark-light/10 h-5 w-full overflow-hidden rounded-full bg-dark-light p-1 shadow-3xl dark:shadow-none">
                                        <div
                                            class="ltr:before:right-0.5 rtl:before:left-0.5 relative h-full w-full rounded-full bg-gradient-to-r from-[#009ffd] to-[#2a2a72] before:absolute before:inset-y-0 before:m-auto before:h-2 before:w-2 before:rounded-full before:bg-white"
                                            style="width: 65%"
                                        ></div>
                                    </div>
                                </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="w-full flex-initial px-3">
                                ...
                                <div>
                                    <div class="dark:bg-dark-light/10 h-5 w-full overflow-hidden rounded-full bg-dark-light p-1 shadow-3xl dark:shadow-none">
                                        <div
                                            class="ltr:before:right-0.5 rtl:before:left-0.5 relative h-full w-full rounded-full bg-gradient-to-r from-[#a71d31] to-[#3f0d12] before:absolute before:inset-y-0 before:m-auto before:h-2 before:w-2 before:rounded-full before:bg-white"
                                            style="width: 40%"
                                        ></div>
                                    </div>
                                </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="w-full flex-initial px-3">
                                ...
                                <div>
                                    <div class="dark:bg-dark-light/10 h-5 w-full overflow-hidden rounded-full bg-dark-light p-1 shadow-3xl dark:shadow-none">
                                        <div
                                            class="ltr:before:right-0.5 rtl:before:left-0.5 relative h-full w-full rounded-full bg-gradient-to-r from-[#fe5f75] to-[#fc9842] before:absolute before:inset-y-0 before:m-auto before:h-2 before:w-2 before:rounded-full before:bg-white"
                                            style="width: 25%"
                                        ></div>
                                    </div>
                                </div>
                ...
                <div class="panel h-full p-0 overflow-hidden">
                    <div class="flex p-5">
                        <div
                    ...
                    <div class="h-40">
                        <client-only>
                            <apexchart height="160" :options="followers" :series="followersSeries" class="absolute bottom-0 w-full overflow-hidden">
                                <!-- loader -->
                                <div class="dark:bg-opacity-[0.08] grid min-h-[160px] place-content-center bg-white-light/30 dark:bg-dark">
                                    <span
                                        class="inline-flex h-5 w-5 animate-spin rounded-full border-2 border-black !border-l-transparent dark:border-white"
                                    ></span>
                                </div>
                ...
                <div class="panel h-full p-0 overflow-hidden">
                    ...
                    <div class="h-40">
                        <client-only>
                            <apexchart height="160" :options="referral" :series="referralSeries" class="absolute bottom-0 w-full overflow-hidden">
                                <!-- loader -->
                                <div class="dark:bg-opacity-[0.08] grid min-h-[160px] place-content-center bg-white-light/30 dark:bg-dark">
                                    <span
                                        class="inline-flex h-5 w-5 animate-spin rounded-full border-2 border-black !border-l-transparent dark:border-white"
                ...
                <div class="panel h-full p-0 overflow-hidden">
                    ...
                    <div class="h-40">
                        <client-only>
                            <apexchart height="160" :options="engagement" :series="engagementSeries" class="absolute bottom-0 w-full overflow-hidden">
                                <!-- loader -->
                                <div class="dark:bg-opacity-[0.08] grid min-h-[160px] place-content-center bg-white-light/30 dark:bg-dark">
                                    <span
                                        class="inline-flex h-5 w-5 animate-spin rounded-full border-2 border-black !border-l-transparent dark:border-white"
            ...
            <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                <div class="panel h-full">
                    <div class="dark:border-[#1b2e4b] -m-5 mb-5 flex items-start border-b border-[#e0e6ed] p-5">
                        ...
                        <div class="absolute bottom-0 -mx-5 flex w-full items-center justify-between p-5">
                            <div class="flex items-center">
                                <svg
                                    ...
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="ltr:mr-1.5 rtl:ml-1.5 relative -top-0.5 inline h-5 w-5 text-info"
                                >
                                    <path
                            ...
                            <a
                                href="javascript:;"
                                class="hover:shadow-[0_10px_20px_-10px] flex items-center rounded-md bg-success/30 px-1.5 py-1 text-xs text-success hover:shadow-success"
                                >Read More
                                <svg
                                    width="24"
                                    height="24"
                                    ...
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="ltr:ml-1.5 rtl:mr-1.5 h-4 w-4 rtl:rotate-180"
                                >
                ...
                <div class="panel h-full">
                    <div class="dark:border-[#1b2e4b] -m-5 mb-5 flex items-center justify-between border-b border-[#e0e6ed] p-5">
                        <div class="flex">
                ...
                <div class="panel h-full">
                    ...
                    <div class="group">
                        ...
                        <div class="mb-2 flex items-center justify-between font-semibold">
                            <div class="flex items-center">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-success">
                                    <path
                                        opacity="0.5"
                        ...
                        <div class="dark:bg-dark-light/10 mb-5 h-2.5 rounded-full bg-dark-light p-0.5">
