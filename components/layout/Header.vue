            ...
            <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                    <NuxtLink to="/" class="main-logo flex shrink-0 items-center">
                        <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="/assets/images/logo_sm.png" alt="" />
                        <span
                            ...
                            <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8" class="!block">
                                <button type="button" class="group relative block">
                                    <img
                                        ...
                                        :src="`https://ui-avatars.com/api/?name=${authStore?.authUser?.name}&background=random`"
                                        alt=""
                                    />
                                </button>
                                <template #content="{ close }">
                                    <ul class="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                        <li>
                                            <div class="flex items-center px-4 py-4">
                                                <div class="flex-none">
                                                    ...
                                                    <img class="h-10 w-10 rounded-md object-cover" :src="`https://ui-avatars.com/api/?name=${authStore?.authUser?.name}&background=random`" alt="" />
                                        ...
                                        <li class="border-t border-white-light dark:border-white-light/10">
                                            ...
                                            <a v-else href="javascript:void(0)" class="!py-3 text-danger" @click="logoutUser">
                                                <svg
